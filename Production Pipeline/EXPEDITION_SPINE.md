...
| 3 | `RP-003` | Final foundation-phase slice: bounded correspondence, difference, and unavailable-evidence comparison | `IN DESIGN — A1 COMPLETE` | Assign only during its contiguous A3 pass | Assign only during its contiguous A3 pass | `TBD by A4` | `RP-002` specified end state | A2 composes the smallest registered invariant-world scene sequence; RP-004 remains reserved |
...
- Current verdict is `RP-002 PROMOTED TO WORKING`; `RP-003 IN DESIGN — A1 COMPLETE`. The RP-003 Story gate is closed with a direct predecessor match, bounded real-Python occupational comparison, zero-city-delta end state, and exact A2 handoff. RP-004 remains reserved.
