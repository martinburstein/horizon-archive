...
| 3 | `RP-003` | Final foundation-phase slice: bounded correspondence, difference, and unavailable-evidence comparison | `IN DESIGN — A3 COMPLETE` | `PY-010 SOLIDIFIED`; conditional-only reinforcement over supplied scaffold | `RP003-IE-01 SOLIDIFIED`; focused `AI901-D2-O7` retrieval/transfer | `TBD by A4` | `RP-002` specified end state | A4 builds one bounded graph from the locked mapping; RP-004 remains reserved |
...
- Current verdict is `RP-002 PROMOTED TO WORKING`; `RP-003 IN DESIGN — A3 COMPLETE`. RP-003 now has a locked direct-predecessor story contract, one invariant-world `SC-04` production brief, and a SOLIDIFIED `PY-010` plus focused `RP003-IE-01 / AI901-D2-O7` contract with strict primary/remediation/retrieval/fresh-transfer evidence. A4 owns one bounded graph; RP-004 remains reserved.
