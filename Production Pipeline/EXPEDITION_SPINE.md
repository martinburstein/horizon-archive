...
| 3 | `RP-003` | Final foundation-phase slice: bounded correspondence, difference, and unavailable-evidence comparison | `IN DESIGN — A4 COMPLETE` | `PY-010 SOLIDIFIED`; conditional-only reinforcement over supplied scaffold | `RP003-IE-01 SOLIDIFIED`; focused `AI901-D2-O7` retrieval/transfer | `24–32 min` clean; `14–18 min` mastered replay; protected smoke target `<5 min` | `RP-002` specified end state | A5 builds one pure protected journey/harness from the locked graph; RP-004 remains reserved |
...
- Current verdict is `RP-002 PROMOTED TO WORKING`; `RP-003 IN DESIGN — A4 COMPLETE`. RP-003 now has a locked direct-predecessor story contract, one invariant-world `SC-04` production brief, a SOLIDIFIED `PY-010` plus focused `RP003-IE-01 / AI901-D2-O7` contract, and one bounded recoverable `CM-00 -> CM-50` puzzle graph. A5 owns one protected journey/harness; RP-004 remains reserved.
