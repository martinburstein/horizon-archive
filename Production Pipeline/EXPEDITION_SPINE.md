...
| 3 | `RP-003` | Final foundation-phase slice: bounded correspondence, difference, and unavailable-evidence comparison | `GATE REVIEW — A5 HANDOFF` | `PY-010 SOLIDIFIED`; protected 8/8 primary/retrieval/blank-transfer journey passed | `RP003-IE-01 SOLIDIFIED`; protected 3/3 primary/retrieval/blank-transfer journey passed | `24–32 min` clean; `14–18 min` mastered replay; protected smoke passed in milliseconds | `RP-002` specified end state | Coordinator verifies the protected bundle and either promotes or records one hold; RP-004 remains reserved |
