...
| 3 | `RP-003` | Final foundation-phase slice: bounded correspondence, difference, and unavailable-evidence comparison | `IN DESIGN — A2 COMPLETE` | Assign only during its contiguous A3 pass | Assign only during its contiguous A3 pass | `TBD by A4` | `RP-002` specified end state | A3 selects and verifies only the contiguous learning mapping; RP-004 remains reserved |
...
- Current verdict is `RP-002 PROMOTED TO WORKING`; `RP-003 IN DESIGN — A2 COMPLETE`. RP-003 now has a locked direct-predecessor story contract and one invariant-world `SC-04` production brief with four compact phases, responsive/accessibility planning, and zero-city-delta causality. A3 owns only the contiguous learning mapping; RP-004 remains reserved.
