...
| 3 | `RP-003` | `Calibration Margin — City Beneath` | `RP-002 comparison saved -> adjacent survey direction marked` | `IN DESIGN — A3 COMPLETE / A4 NEXT` | `NOT READY` | `PASS — SURFACE PREMISE/GOAL/END STATE LOCKED` | `PASS — SC-04 INVARIANT-WORLD BRIEF LOCKED` | `PY-010 SOLIDIFIED — 8/8 PRIMARY + RETRIEVAL + BLANK 8/8 TRANSFER` | `RP003-IE-01 SOLIDIFIED — FOCUSED AI901-D2-O7 3/3 + 3/3 + 3/3` | `UNASSIGNED — A4 NEXT` | `MISSING — A5` | Curriculum gate closed under the official July 16 source check. Supplied scaffold is unscored; observations/presentation/save/Tour are zero credit; privacy, offline/no-authority/no-exam-guarantee, invariant world, and no-RP-004 locks remain exact. A4 owns one bounded graph only. |
