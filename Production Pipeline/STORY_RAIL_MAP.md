...
| 3 | `RP-003` | `Calibration Margin — City Beneath` | `RP-002 comparison saved -> adjacent survey direction marked` | `IN DESIGN — A2 COMPLETE / A3 NEXT` | `NOT READY` | `PASS — SURFACE PREMISE/GOAL/END STATE LOCKED` | `PASS — SC-04 INVARIANT-WORLD BRIEF LOCKED` | `UNASSIGNED — A3 NEXT` | `UNASSIGNED — A3 NEXT` | `UNASSIGNED — A4` | `MISSING — A5` | One registered premium 16:9 master now supports four compact phases, structural correspondence/difference/unavailability evidence, occupational Builder logic, responsive/accessibility planning, provenance, and zero physical city response. A3 owns the mapping only; RP-004 remains reserved. |
