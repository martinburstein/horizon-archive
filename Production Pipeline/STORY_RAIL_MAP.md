...
- Team 1 railhead: `RP-002 — A1 atomic persistence/save meaning complete after the protected learning model; A2 impact review next; later seams remain REVISE`
- Ordered Advance lead beyond Team 2 active packet: `1 packet — RP-002 protected learning state model complete through the exact Pilot conclusion; atomic save meaning locked, while A2–A5 save integration, observation, UI, route, and art remain in design`
...
| 2 | `RP-002` | `Civic Record Encounter — City Beneath` | `RP-001 anchor complete -> civic route available` | `IN DESIGN — A5 PARTIAL / REVISE` | `NOT READY / NON-ROUTABLE` | `LORE LOCKED — EXECUTABLE LITERACY + HUMAN RAI + ATOMIC SAVE OWNERSHIP` | `A2 ATOMIC PERSISTENCE/SAVE IMPACT REVIEW NEXT` | `PY-009 SOLIDIFIED + PROTECTED MODEL COMPLETE` | `RP002-RAI-01 SOLIDIFIED + PROTECTED MODEL COMPLETE THROUGH PILOT CONCLUSION` | `A4 RAI TRANSFER/EXPLANATION GRAPH LOCKED; SAVE GRAPH IMPACT PENDING` | `TOUR + PREREQUISITE + PY-009 30-A THROUGH 30-E + FULL RAI STATE MODEL COMPLETE` | A1 now locks the post-conclusion human review, explicit save intent, exact all-or-none three-field local commit, recoverable failure, stale downgrade, and verified restoration meanings. Presentation, save code, observation, responsive UI, protected/normal routing, successor exposure, art, world change, authority, and Working promotion remain disabled. W1 stays on accepted RP-001. |
