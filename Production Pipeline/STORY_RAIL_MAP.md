...
- Team 2 active packet: `RP-001 — IN DEMO / ACCEPTED; W3 CLEAN FROM AVAILABLE EVIDENCE AFTER 727eecd, W4 VERIFICATION/FINAL RELOAD NEXT`
- Team 1 railhead: `RP-002 — A5 partial; protected RAI primary/remediation/transfer/explanation model complete, later integration seams remain REVISE`
- Ordered Advance lead beyond Team 2 active packet: `1 packet — RP-002 protected learning state model complete through the exact Pilot conclusion; persistence/save, observation, UI, route, and art remain in design`
...
|---:|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | `RP-001` | `City Threshold — City Beneath` | `Witness Corridor complete -> City Beneath credits` | `PROMOTED TO WORKING — 7001340` | `IN DEMO — ACCEPTED / W3 CLEAN; W4 NEXT` | `LORE LOCKED` | `STORYBOARD LOCKED` | `PY-020 SOLIDIFIED` | `CUM-01 SOLIDIFIED` | `A4 LOCKED` | `FUNCTIONAL + PHOTOREAL PASS` | The 2026-07-16 W3 pass after checkpoint `727eecd` opened no aesthetic finding from original-size review of the four accepted `1672 x 941` masters, provenance, active responsive source, focused `38/38`, and exact-asset HTTP checks. The browser surface was unavailable to W3, so W4/coordinator retains representative desktop/narrow live confirmation before release disposition. Protected RP-002 remains non-routable. |
| 2 | `RP-002` | `Civic Record Encounter — City Beneath` | `RP-001 anchor complete -> civic route available` | `IN DESIGN — A5 PARTIAL / REVISE` | `NOT READY / NON-ROUTABLE` | `LORE LOCKED — EXECUTABLE LITERACY + HUMAN RAI TRANSFER/EXPLANATION OWNERSHIP` | `A2 RAI TRANSFER/EXPLANATION PRESENTATION LOCKED` | `PY-009 SOLIDIFIED + PROTECTED MODEL COMPLETE` | `RP002-RAI-01 SOLIDIFIED + PROTECTED MODEL COMPLETE THROUGH PILOT CONCLUSION` | `A4 RAI TRANSFER/EXPLANATION GRAPH LOCKED` | `TOUR + PREREQUISITE + PY-009 30-A THROUGH 30-E + FULL RAI STATE MODEL COMPLETE` | Protected A5 now implements blank T01–T03 transfer, strict simultaneous `9/9`, mapped Teacher feedback, neutral zero-credit practice, blank first-failed retry, separately scored three-boundary explanation/blank retry, exact Pilot conclusion, deterministic privacy-limited reconstruction, Python separation, and invariant campaign/Tour/world/city/route state. Persistence/save, observation, responsive UI, protected/normal routing, successor exposure, art, world change, authority, and Working promotion remain disabled. W1 stays on accepted RP-001. |
