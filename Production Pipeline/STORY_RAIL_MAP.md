...
- Team 2 active packet: `RP-001 — IN DEMO / ACCEPTED; COORDINATOR CLEAN PASS`
- Team 1 railhead: `RP-002 — A5 partial; A4 RAI transfer/explanation graph confirmation complete, A5 protected construction next`
- Ordered Advance lead beyond Team 2 active packet: `1 packet — RP-002 RAI primary/remediation protected and transfer/explanation ownership/presentation/mapping/graph locked; later seams remain in design`
...
|---:|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | `RP-001` | `City Threshold — City Beneath` | `Witness Corridor complete -> City Beneath credits` | `PROMOTED TO WORKING — 7001340` | `IN DEMO — ACCEPTED / COORDINATOR CLEAN PASS` | `LORE LOCKED` | `STORYBOARD LOCKED` | `PY-020 SOLIDIFIED` | `CUM-01 SOLIDIFIED` | `A4 LOCKED` | `FUNCTIONAL + PHOTOREAL PASS` | W3/W4 found no reproducible aesthetic issue; coordinator live desktop/narrow review, `280/280` game suite, production build, curriculum validator, and full title-to-credits E2E all pass. No speculative visual change is authorized and protected RP-002 remains non-routable. |
| 2 | `RP-002` | `Civic Record Encounter — City Beneath` | `RP-001 anchor complete -> civic route available` | `IN DESIGN — A5 PARTIAL` | `NOT READY` | `LORE LOCKED — EXECUTABLE LITERACY + HUMAN RAI TRANSFER/EXPLANATION OWNERSHIP` | `A2 RAI TRANSFER/EXPLANATION PRESENTATION LOCKED` | `PY-009 SOLIDIFIED + PROTECTED MODEL COMPLETE` | `RP002-RAI-01 SOLIDIFIED; A3 TRANSFER/EXPLANATION NO-REOPEN LOCK` | `A4 RAI TRANSFER/EXPLANATION GRAPH LOCKED` | `TOUR + PREREQUISITE + PY-009 30-A THROUGH 30-E + RAI PRIMARY/REMEDIATION COMPLETE` | A4 confirms the post-primary graph: blank System-owned `9/9` transfer; mapped Teacher feedback, neutral zero-credit practice, and blank retry on a miss; separately scored Teacher-owned application-label/native-fact/authority explanation with blank retry; then the exact Pilot conclusion. Strict simultaneous scoring, one-active-group unlimited recovery, privacy allowlist, deterministic reconstruction, completed Python separation, no-save/no-authority boundaries, invariant campaign/Tour/world/city/route, and zero-credit presentation remain exact. A5 may implement only this protected transfer/explanation seam. Persistence/save, observation, UI, route, successor, art, world state, authority, and Working promotion remain disabled. |
