...
- Team 2 active packet: `RP-001 — IN DEMO / ACCEPTED; W1 CLEAN ON cba6c04, W2 VERIFICATION NEXT`
...
|---:|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | `RP-001` | `City Threshold — City Beneath` | `Witness Corridor complete -> City Beneath credits` | `PROMOTED TO WORKING — 7001340` | `IN DEMO — ACCEPTED / W1 CLEAN` | `LORE LOCKED` | `STORYBOARD LOCKED` | `PY-020 SOLIDIFIED` | `CUM-01 SOLIDIFIED` | `A4 LOCKED` | `FUNCTIONAL + PHOTOREAL PASS` | The 2026-07-16 W1 pass on `cba6c04` passed the focused `38/38` accepted-boundary selection and full campaign E2E in `160.2s` with credits and no runtime errors; no P0/P1/P2 defect was reproduced. W2 verification/reload and root live desktop/narrow confirmation are next. Protected RP-002 remains non-routable. |
