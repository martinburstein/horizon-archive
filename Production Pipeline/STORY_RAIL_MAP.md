...
|---:|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | `RP-001` | `City Threshold — City Beneath` | `Witness Corridor complete -> City Beneath credits` | `PROMOTED TO WORKING — 7001340` | `IN DEMO — ACCEPTED / COORDINATOR CLEAN PASS` | `LORE LOCKED` | `STORYBOARD LOCKED` | `PY-020 SOLIDIFIED` | `CUM-01 SOLIDIFIED` | `A4 LOCKED` | `FUNCTIONAL + PHOTOREAL PASS` | W1-W4 reproduced no defect. Coordinator live desktop/narrow review, `285/285` game suite, production build, curriculum validator, and full title-to-credits E2E all pass for `index-DYIYoZtf.js` / `index-VPnRyv7C.css`. Protected RP-002 remains non-routable. |
