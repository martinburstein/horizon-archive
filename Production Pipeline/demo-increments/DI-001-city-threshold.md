...
- **Verdict:** `REVISE - MEADOW-AESTH-001 P2; ACCEPT FOR W4.` Opening, responsive framing, wired photoreal masters, static membrane stability, and Tour skip source hierarchy remain accepted from available evidence; one root-live focus treatment is reproducibly overemphasized.
...
- **Preserve:** exact hotspot size/semantics/accessible name, fresh and resume focus, keyboard/pointer activation, strong visible focus, integrated art/crop/static membrane, opening, Tour skip confirmation and no-credit isolation, saves/mastery/privacy/no-authority, RP-001 state, continuation/null city delta, and non-routable RP-002.
- **Exact W4 handoff:** `Coder Agent operating mode: aesthetic-polish. Resolve MEADOW-AESTH-001 only: keep the exact 25%,11.1111%,50%,88.8889% field-linked Terminal button and all focus/activation semantics, but remove the full-hit-area focus border/tint and place a strong high-contrast keyboard cue on the existing compact label or an equally small Terminal-anchored indicator. Pointer hover may share the localized treatment. Preserve forced-color visibility and never shrink the target or hide focus. Change no art, crop, membrane, copy, objective, state, opening, Tour skip/no-credit behavior, saves, mastery, RP-001, city, or RP-002 route. Add a focused regression, run focused/full tests/build, reload 4173, and provide root live fresh/resume evidence at 1280x720, 390x844, and 200% zoom with intact activation, no clipping, and no horizontal escape.`
