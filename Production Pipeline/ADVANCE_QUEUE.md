...
| 2 | `RP-002` | Civic Record Encounter | `IN DESIGN — A5 PARTIAL` | Coder Agent (`advance` mode) | A1–A4 passed; A4 ownership-copy impact review passed; reusable protected Demo Tour foundation implemented and tested | Starts only from RP-001 atomic expedition anchor and reversible civic route; SC-03 locks exact boards/targets, premium physical provenance evidence, closed identity-bearing material, zero city delta, unscored world evidence, strict PY-009/RAI gates, copy ownership/layout, and tour/campaign state separation | Continue A5 with protected SC-03 and Custody Ledger scaffolding. Attach owner-prefixed copy only to existing interface nodes; reuse the completed separate tour foundation; do not merge it into campaign evidence or accept placeholder art. |

## Team positions

- Ready packets awaiting promotion: `0`
- Promoted packets awaiting Working acceptance: `1 — RP-001`
- In-design packets: `1 — RP-002 (A5 partial; protected Demo Tour foundation complete)`
- Team 1 railhead: `RP-002 — A5 partial; SC-03 and Custody Ledger pending`
