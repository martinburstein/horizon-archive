...
| 2 | `RP-002` | Civic Record Encounter | `IN DESIGN — A5 PARTIAL` | Coder Agent (`advance` mode) | A1–A4 passed; reusable protected Demo Tour foundation implemented and tested | Starts only from RP-001 atomic expedition anchor and reversible civic route; SC-03 locks exact boards/targets, premium physical provenance evidence, closed identity-bearing material, zero city delta, unscored world evidence, strict PY-009/RAI gates, and tour/campaign state separation | Continue A5 with protected SC-03 and Custody Ledger scaffolding. Reuse the completed separate tour foundation; do not merge it into campaign evidence or accept placeholder art. |
