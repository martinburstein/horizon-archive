...
| 2 | `RP-002` | `FINAL VALIDATION — W4 CLEAN / DEMO RELOADED` | Independently validate only the zero-credit handoff from accepted `SC-03-00` into blank sanitized `SC-03-10` | Coordinator | Fresh direct-path desktop/narrow evidence remains for coordinator review; no W4 defect | Validate exact boundary and release gates; do not activate observations or expose later packets |
