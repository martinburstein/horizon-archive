...
| 2 | `RP-002` | `BUG REPAIR — RP002-P1-003` | Integrate exactly one canonical first-near observation from accepted blank `SC-03-10` | Coder Agent (`W2`, bug-repair mode) | Blank normal surface exposes only route return; all three canonical near actions are absent | Add the three equal first-near controls, one-action/one-ID acknowledgement, bounded resume/recovery, tests, rebuild, and reload; stop before a second observation |
