...
| 7 | `OPENING-AESTH-001` — First-45-seconds opening remained a miniature legacy panel inside the fluid stage | W3 hierarchy review; `demo-increments/DI-001-city-threshold.md` | `RESOLVED IN W4 — COORDINATOR LIVE VALIDATION PENDING` | Coordinator live desktop/narrow/200%-zoom gate |
