...
| 8 | `MEADOW-AESTH-001` — Full primary-hit-area focus treatment dominates the first Glass Meadow plate | Root live `1280 x 720` measurement; W3 source review; `demo-increments/DI-001-city-threshold.md` | `AESTHETIC IMPLEMENTATION` | Coder Agent W4 - localize visible focus without shrinking the target |
