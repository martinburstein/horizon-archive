...
| 8 | `MEADOW-AESTH-FOCUS-001` — Full primary-hit-area focus treatment dominates the first Glass Meadow plate | Root live `1280 x 720` measurement; W3 source review; W4 focused/full/build evidence; `demo-increments/DI-001-city-threshold.md` | `FINAL VALIDATION — W4 RELOADED` | Coordinator — live fresh/resume, narrow/zoom, forced-colors, and other-hotspot focus gate |
