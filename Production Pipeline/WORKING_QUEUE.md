...
| 2 | `RP-002` | `BUG REPAIR — RP002-P1-002` | Add only the player-visible zero-credit handoff from accepted `SC-03-00` into blank sanitized `SC-03-10` | Coder Agent (`W2`, bug-repair mode) | Accepted P0 exposes only return; the approved survey action is absent | Integrate the exact P0-to-blank-`SC-03-10` transition, focused tests, rebuild, and reload; do not activate observations or expose later packets |
