...
| `RP-004` | `PASS — A1 surface contract` | `PASS — SC-05 invariant panoramic brief` | `PASS — PY-011 + RP004-WORKLOAD-01 SOLIDIFIED` | `PASS — TR-00–TR-40 graph locked` | `PASS — pure protected end-to-end journey` | `PASS — contiguous resume, atomic save, verified restore, answer-free recovery` | `PASS — protected metadata/evidence` | `PASS plan / final assets assigned later` | `MISSING — pending promotion` | `N/A` | `GATE REVIEW — A5 HANDOFF` | Coordinator verifies all twelve gates; RP-005 remains reserved |
