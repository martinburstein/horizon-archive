...
| `RP-006` | `PASS — A1 surface contract` | `PASS — SC-07 compact two-master brief` | `PASS — PY-013 + RP006-SPEECH-01 SOLIDIFIED` | `MISSING — A4` | `MISSING — A5` | `PARTIAL — curriculum/save conjunction locked` | `PARTIAL — design contract only` | `PASS plan / final assets later` | `MISSING` | `N/A` | `IN DESIGN — A3 PASS` | A4 composes one bounded graph; SC-07 is zero evidence and RP-007 stays reserved |
