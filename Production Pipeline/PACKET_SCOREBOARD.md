...
| `RP-006` | `PASS — A1 surface contract` | `MISSING — A2 next` | `MISSING` | `MISSING` | `MISSING` | `PARTIAL — meaning locked; implementation unassigned` | `PARTIAL — contract risks locked; implementation unassigned` | `MISSING` | `MISSING` | `N/A` | `IN DESIGN — ORIENTATION CYCLE 1` | A2 closes only the Scene and production-art-plan gates |
