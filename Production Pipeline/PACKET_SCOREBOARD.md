...
| `RP-004` | `MISSING` | `MISSING` | `MISSING` | `MISSING` | `MISSING` | `MISSING` | `MISSING` | `MISSING` | `MISSING` | `N/A` | `SEED / RESERVED SHELL` | Lore Builder A1 defines only the smallest contiguous surface-safe slice next cycle |
