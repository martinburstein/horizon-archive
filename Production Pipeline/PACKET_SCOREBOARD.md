...
| `RP-005` | `PASS — A1 surface contract` | `PASS — SC-06 compact two-master brief` | `PASS — PY-012 + RP005-TEXT-01 SOLIDIFIED` | `MISSING — A4` | `MISSING — A5` | `PARTIAL — curriculum/save conjunction locked; implementation pending` | `PARTIAL — design contract only` | `PASS plan / final assets later` | `MISSING` | `N/A` | `IN DESIGN — A3 PASS` | A4 composes one bounded graph; visual distribution remains zero mastery evidence and RP-006 stays reserved |
