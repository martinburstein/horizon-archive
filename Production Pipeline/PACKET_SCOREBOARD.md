...
| `RP-002` | `PASS` | `PASS — compact convergence locked` | `PASS — A3 convergence audit locked; spine active` | `PASS — A4 integrated graph locked; gameplay spine active` | `PASS — protected P0–P3 journey smoke` | `PASS — atomic save/restore and deterministic recovery` | `PASS — protected metadata/evidence` | `P0 accepted / blank view reuses accepted master / later assets planned` | `PARTIAL — normal P0 through blank SC-03-10 accepted` | `PARTIAL — two bounded W1–W4 cycles + coordinator passes` | `IN DEMO — PARTIAL` | Next W1 begins at accepted blank SC-03-10 and reports the earliest gap toward one first near observation; do not skip ahead |
...
| `RP-005` | `PASS — A1 surface contract` | `PASS — SC-06 compact two-master brief` | `PASS — PY-012 + RP005-TEXT-01 SOLIDIFIED` | `PASS — MF-00→MF-30 graph locked` | `PASS — pure protected end-to-end journey` | `PASS — contiguous resume, atomic save, replay-free restore, answer-free recovery` | `PASS — protected metadata/evidence` | `PASS plan / final assets later` | `MISSING — later stage` | `N/A` | `GATE REVIEW — A5 HANDOFF` | Coordinator independently verifies all twelve gates; promote behind RP-004 or record one genuine hold; no new protected micro-seam first |
| `RP-006`–`RP-012` | `MISSING` | `MISSING` | `MISSING` | `MISSING` | `MISSING` | `MISSING` | `MISSING` | `MISSING` | `MISSING` | `N/A` | `SPINE RESERVED` | Preserve sequence; do not invent non-contiguous content |
