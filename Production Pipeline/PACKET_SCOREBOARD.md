...
| `RP-006` | `PASS — A1 surface contract` | `PASS — SC-07 compact two-master brief` | `PASS — PY-013 + RP006-SPEECH-01 SOLIDIFIED` | `PASS — IW-00→IW-30 graph locked` | `MISSING — A5` | `PARTIAL — atomic save/restore and deterministic recovery designed; implementation pending` | `PARTIAL — complete design contract; protected evidence pending` | `PASS plan / final assets later` | `MISSING` | `N/A` | `IN DESIGN — A4 PASS` | A5 builds one pure protected journey/harness; prove 24 observation orders, strict independent chains, exact gap/cause preservation, scenery/order/sound/Tour isolation, invariant world, and no RP-007 |
