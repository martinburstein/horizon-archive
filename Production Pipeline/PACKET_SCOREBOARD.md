...
| `RP-005` | `PASS — A1 surface contract` | `MISSING — A2 next` | `MISSING — A3` | `MISSING — A4` | `MISSING — A5` | `PARTIAL — lore locks only` | `PARTIAL — anticipated risks only` | `MISSING — A2 plan` | `MISSING` | `N/A` | `IN DESIGN — ORIENTATION` | A2 composes one registered invariant-field sequence; later roles assign only their own tracks |
