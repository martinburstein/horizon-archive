...
$helperRoot='C:\Users\marti\AppData\Local\Temp\horizon-archive-host06-native-identity-v13-1a72c913-2a4c-4c2e-89a6-258748b7f27b'
...
try {
  ...
  if ($source.Length-ne 36477-or$sourceBytes.Length-ne 36477) { throw 'PH01_STDIN_RETRIEVAL' }
  foreach($character in $source.ToCharArray()){if([int]$character-gt 127){throw 'PH01_STDIN_RETRIEVAL'}}
  $sha=[Security.Cryptography.SHA256]::Create()
  if (([BitConverter]::ToString($sha.ComputeHash($sourceBytes))).Replace('-','').ToLowerInvariant()-cne'edbe01ea2a7a7b158f09c4882f66ba1a21db72ce5fdff01775608671b193df83'){throw 'PH01_STDIN_RETRIEVAL'}
