...
$liveRoot='C:\Users\marti\AppData\Local\Temp\horizon-archive-host06-api-v14-9783dcf8-7526-475e-b92e-d0abd931c7a3'
...
"@
  ...
  if ($promptBytes.Length -ne 6031 -or ([BitConverter]::ToString($sha.ComputeHash($promptBytes))).Replace('-','').ToLowerInvariant() -cne 'a052c74d83f574fe6628651c2f5b5de54e655468d35b97d076cccd7b35df3086') { throw 'PT08_REQUEST_SCHEMA' }
  Add-Type -AssemblyName System.Net.Http -ErrorAction Stop
  Add-Type -AssemblyName System.Web.Extensions -ErrorAction Stop
  $jsonGuardSource=@"
using System;
using System.Collections.Generic;
namespace HorizonArchive.Host06V14 {
...
"@
  ...
  $production.AttemptId='G1'
  $production.Stage='PT09_SEND_ENTRY'
  $stagePath=$liveRoot+'\.attempt-G1-f76e28bb-7e72-437b-ab45-b17c4b27c45e.stage'
  $targetPath=$liveRoot+'\attempt-G1.png'
  $decisionPath=$liveRoot+'\.attempt-G1.review-v1'
  ...
  try{[HorizonArchive.Host06V14.StrictJson]::Validate($responseText);$responseObject=$serializer.DeserializeObject($responseText)}catch{throw 'PT10_RESPONSE_ENVELOPE'}
  if($status-ne 200){
    try{
  ...
  $production.Stage='PT12_MATERIALIZE_STAGE'
    ...
    [Console]::Out.WriteLine('HOST06_REVIEW_READY|attemptId=G1'+'|length='+$targetIdentity[4]+'|sha256='+$decodedSha)
    ...
    $decisionPattern='\AHOST06_REVIEW_V1\|attemptId=G1\|decision=(?<decision>ACCEPT|REJECT)\|technical=true\|physical=(?<physical>true|false)\|layouts=(?<layouts>true|false)\|accessibility=(?<accessibility>true|false)\|codes=(?<codes>NONE|PHY(?:-\d{2})(?:,PHY-\d{2})*|LAYOUT|ACCESSIBILITY)\n\z'
    ...
    $provenance="# HOST06 Source Provenance`n`nWork Order: FRWO-005-v17`nShell: FRSH-005-v1-VR-45`nHelper: HOST06-FILE-IDENTITY-PSNET-v1`nHelper source: 1693 / 98cf564b7d22da686adc204a3f6051927ac2d37ef7b5f2fe22d774cb10d5da97`nHelper DLL: "+$dllLength+" / "+$dllSha+"`nTransport: HOST06-IMAGE-API-PSNET-v1`nEndpoint: https://api.openai.com/v1/images/generations`nModel/options: gpt-image-2 / n=1 / 3840x2160 / high / opaque / png`nPrompt: HOST06-GEN-PROMPT-v4 / 6031 / a052c74d83f574fe6628651c2f5b5de54e655468d35b97d076cccd7b35df3086 / no input`nConsumed attempt ID: G1 accepted`nSelected attempt ID/path: G1 / attempt-G1.png`nSelected identity: "+$targetIdentity[4]+" / "+$decodedSha+"`nTechnical/physical/layout/accessibility: pass / pass / pass / pass`nManifest: c7ca95201029b490f2460a846e3dc2a64a26775b57e8c587cbc2d874df654d99`nProduct: Visual Direction/Production Masters/2026-08-10-first-run-host06/host06-stranded-lens-cradle-master-v1.png`nAccepted media unchanged: true`nHelper/live cleanup: complete`n"
    ...
    [Console]::Out.WriteLine('HOST06_PRODUCTION_COMPLETE|attemptId=G1'+'|length='+$targetIdentity[4]+'|sha256='+$decodedSha+'|helperRootAbsent=true|liveRootAbsent=true')
    break
} catch {
