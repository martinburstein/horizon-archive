...
State ID: `FRLS-IMG-020-v1`

Control: `FRCV-001-v1` / `HA-RI-001-v1`

Status: **OPERATE / HOST 33 INTEGRATION CANDIDATE / HOST 34 NEXT**
...
state:
  source_control_read: 676eb9f7
  current_asset: host-34
...
queue:
  produced_pending_integration: 7
  integration_candidate: 20
...
evidence:
  ...
  fresh_required:
    - host-34 master identity provenance and affected runtime boundary evidence
  fresh_passed:
...
next_owner: runtime_integration_controller_host_34
```
