...
State ID: `FRLS-IMG-019-v1`

Control: `FRCV-001-v1` / `HA-RI-001-v1`

Status: **OPERATE / HOST 32 INTEGRATION CANDIDATE / HOST 33 NEXT**
...
state:
  source_control_read: 2f734d65
  current_asset: host-33
  current_address: FR-13
...
queue:
  produced_pending_integration: 8
  integration_candidate: 19
...
evidence:
  ...
  fresh_required:
    - host-33 master identity provenance and affected runtime boundary evidence
  fresh_passed:
...
next_owner: runtime_integration_controller_host_33
```
