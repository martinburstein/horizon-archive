...
State ID: `FRLS-IMG-004-v1`

Control: `FRCV-001-v1` / `HA-RI-001-v1`

Status: **OPERATE / HOST 17 INTEGRATION CANDIDATE / HOST 18 NEXT**
...
state:
  source_control_read: cce4c78a
  current_asset: host-18
...
queue:
  produced_pending_integration: 23
  integration_candidate: 4
...
evidence:
  ...
  fresh_required:
    - host-18 master identity provenance and affected runtime boundary evidence
  fresh_passed:
...
next_owner: runtime_integration_controller_host_18
```
