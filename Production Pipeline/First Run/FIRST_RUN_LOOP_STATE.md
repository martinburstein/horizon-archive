...
State ID: `FRLS-IMG-010-v1`

Control: `FRCV-001-v1` / `HA-RI-001-v1`

Status: **OPERATE / HOST 23 INTEGRATION CANDIDATE / HOST 24 NEXT**
...
state:
  source_control_read: 1ea657fa
  current_asset: host-24
  current_address: FR-08
...
queue:
  produced_pending_integration: 17
  integration_candidate: 10
...
evidence:
  ...
  fresh_required:
    - host-24 master identity provenance and affected runtime boundary evidence
  fresh_passed:
...
next_owner: runtime_integration_controller_host_24
```
