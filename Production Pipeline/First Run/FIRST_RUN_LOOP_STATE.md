...
State ID: `FRLS-IMG-008-v1`

Control: `FRCV-001-v1` / `HA-RI-001-v1`

Status: **OPERATE / HOST 21 INTEGRATION CANDIDATE / HOST 22 NEXT**
...
state:
  source_control_read: f7724c99
  current_asset: host-22
...
queue:
  produced_pending_integration: 19
  integration_candidate: 8
...
evidence:
  ...
  fresh_required:
    - host-22 master identity provenance and affected runtime boundary evidence
  fresh_passed:
...
next_owner: runtime_integration_controller_host_22
```
