...
State ID: `FRLS-IMG-018-v1`

Control: `FRCV-001-v1` / `HA-RI-001-v1`

Status: **OPERATE / HOST 31 INTEGRATION CANDIDATE / HOST 32 NEXT**
...
state:
  source_control_read: 7bb8e762
  current_asset: host-32
...
queue:
  produced_pending_integration: 9
  integration_candidate: 18
...
evidence:
  ...
  fresh_required:
    - host-32 master identity provenance and affected runtime boundary evidence
  fresh_passed:
...
next_owner: runtime_integration_controller_host_32
```
