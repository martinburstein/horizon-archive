...
State ID: `FRLS-IMG-009-v1`

Control: `FRCV-001-v1` / `HA-RI-001-v1`

Status: **OPERATE / HOST 22 INTEGRATION CANDIDATE / HOST 23 NEXT**
...
state:
  source_control_read: 721d2bed
  current_asset: host-23
...
queue:
  produced_pending_integration: 18
  integration_candidate: 9
...
evidence:
  ...
  fresh_required:
    - host-23 master identity provenance and affected runtime boundary evidence
  fresh_passed:
...
next_owner: runtime_integration_controller_host_23
```
