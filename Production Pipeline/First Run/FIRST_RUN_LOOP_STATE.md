...
State ID: `FRLS-IMG-015-v1`

Control: `FRCV-001-v1` / `HA-RI-001-v1`

Status: **OPERATE / HOST 28 INTEGRATION CANDIDATE / HOST 29 NEXT**
...
state:
  source_control_read: d972b504
  current_asset: host-29
...
queue:
  produced_pending_integration: 12
  integration_candidate: 15
...
evidence:
  ...
  fresh_required:
    - host-29 master identity provenance and affected runtime boundary evidence
  fresh_passed:
...
next_owner: runtime_integration_controller_host_29
```
