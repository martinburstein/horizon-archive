...
State ID: `FRLS-IMG-023-v1`

Control: `FRCV-001-v1` / `HA-RI-001-v1`

Status: **OPERATE / HOST 36 INTEGRATION CANDIDATE / HOST 37 NEXT**
...
state:
  source_control_read: b1300889
  current_asset: host-37
  current_address: FR-15
...
queue:
  produced_pending_integration: 4
  integration_candidate: 23
...
evidence:
  ...
  fresh_required:
    - host-37 master identity provenance and affected runtime boundary evidence
  fresh_passed:
...
next_owner: runtime_integration_controller_host_37
```
