...
State ID: `FRLS-IMG-011-v1`

Control: `FRCV-001-v1` / `HA-RI-001-v1`

Status: **OPERATE / HOST 24 INTEGRATION CANDIDATE / HOST 25 NEXT**
...
state:
  source_control_read: 167d23aa
  current_asset: host-25
  current_address: FR-09
...
queue:
  produced_pending_integration: 16
  integration_candidate: 11
...
evidence:
  ...
  fresh_required:
    - host-25 master identity provenance and affected runtime boundary evidence
  fresh_passed:
...
next_owner: runtime_integration_controller_host_25
```
