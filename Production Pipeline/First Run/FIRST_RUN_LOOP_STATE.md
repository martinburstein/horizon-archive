...
State ID: `FRLS-IMG-021-v1`

Control: `FRCV-001-v1` / `HA-RI-001-v1`

Status: **OPERATE / HOST 34 INTEGRATION CANDIDATE / HOST 35 NEXT**
...
state:
  source_control_read: e8e0edfc
  current_asset: host-35
  current_address: FR-14
...
queue:
  produced_pending_integration: 6
  integration_candidate: 21
...
evidence:
  ...
  fresh_required:
    - host-35 master identity provenance and affected runtime boundary evidence
  fresh_passed:
...
next_owner: runtime_integration_controller_host_35
```
