...
try{
  ...
  Assert-Outer ($parentSourceBytes.Length-eq 58512) 'PARENT_SOURCE_LENGTH'
  Assert-Outer ((Get-Sha256Hex $parentSourceBytes)-ceq'943d3e83da37d3cba45f35833e2e283b24e9e1434ed137144a7df31ae6169c39') 'PARENT_SOURCE_SHA256'
  ...
  Assert-Outer ($parentSource.Length-eq 58512) 'PARENT_SOURCE_CHARACTERS'
