...
try{
  ...
  if($carrierBytes.Length-ne 34766-or([BitConverter]::ToString($sha.ComputeHash($carrierBytes))).Replace('-','').ToLowerInvariant()-cne'2b029ef83752051bb5e255e269d291e47a6449a960f13d4a35311c78a257194e'){throw 'PARENT_CARRIER_IDENTITY'}
  ...
  if($launcherBytes.Length-ne 2637-or$launcherHash-cne'22ecacfe490a27492fef4826ec73fb898a4b095985b78b85f316cadc418d5d43'){throw 'PARENT_LAUNCHER_IDENTITY'}
