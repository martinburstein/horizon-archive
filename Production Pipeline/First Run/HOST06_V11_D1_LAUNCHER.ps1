...
try {
  ...
  if ($source.Length-ne 34948-or$sourceBytes.Length-ne 34948) { throw 'PH01_STDIN_RETRIEVAL' }
  foreach($character in $source.ToCharArray()){if([int]$character-gt 127){throw 'PH01_STDIN_RETRIEVAL'}}
  $sha=[Security.Cryptography.SHA256]::Create()
  if (([BitConverter]::ToString($sha.ComputeHash($sourceBytes))).Replace('-','').ToLowerInvariant()-cne'48a0b3556db83ec5fa6266b3e248c763dd3ed50b009271ea0f39e432152f5392'){throw 'PH01_STDIN_RETRIEVAL'}
