...
$parentPath=Join-Path $root 'HOST06_V10_C1_STDIN_PARENT.ps1'
$controlled=@(
'C:\Users\marti\AppData\Local\Temp\horizon-archive-host06-native-identity-v10-ea8cf781-baba-4d6b-bf86-6424f54fab99',
'C:\Users\marti\AppData\Local\Temp\horizon-archive-host06-api-v10-3ac708f4-5a20-466e-9c18-14cc66a82d59',
...
try{
  ...
  [Console]::Out.WriteLine('HOST06_V10_STDIN_FIXTURE_PASS|earliestStage=PT06_CREDENTIAL_GATE|childInvocations=1|credentialReads=0|requestConstructions=0|sendAsyncCalls=0|apiSends=0|C1Consumed=false|controlledPathsAbsent=true')
