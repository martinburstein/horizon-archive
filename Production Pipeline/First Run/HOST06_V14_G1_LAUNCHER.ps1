...
$helperRoot='C:\Users\marti\AppData\Local\Temp\horizon-archive-host06-native-identity-v14-5aa24cb3-86e9-4a21-babf-1e00f708ef18'
...
try {
  ...
  if ($source.Length-ne 37122-or$sourceBytes.Length-ne 37122) { throw 'PH01_STDIN_RETRIEVAL' }
  foreach($character in $source.ToCharArray()){if([int]$character-gt 127){throw 'PH01_STDIN_RETRIEVAL'}}
  $sha=[Security.Cryptography.SHA256]::Create()
  if (([BitConverter]::ToString($sha.ComputeHash($sourceBytes))).Replace('-','').ToLowerInvariant()-cne'2b3884414360c773e487935fee16e71188d9cda9baa70f6738ab533703cb57f9'){throw 'PH01_STDIN_RETRIEVAL'}
