...
$parentPath=Join-Path $root 'HOST06_V15_H1_STDIN_PARENT.ps1'
$controlled=@(
'C:\Users\marti\AppData\Local\Temp\horizon-archive-host06-native-identity-v15-a335da89-6a58-47dc-9c69-3490c2ecba2c',
'C:\Users\marti\AppData\Local\Temp\horizon-archive-host06-api-v15-17059928-4505-46a4-9b97-7f18058fb411',
...
try{
  ...
  [Console]::Out.WriteLine('HOST06_V15_STDIN_FIXTURE_PASS|earliestStage=PT06_CREDENTIAL_GATE|childInvocations=1|credentialReads=0|requestConstructions=0|sendAsyncCalls=0|apiSends=0|H1Consumed=false|controlledPathsAbsent=true')
