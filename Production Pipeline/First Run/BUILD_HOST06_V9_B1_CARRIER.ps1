...
$carrierPath = Join-Path $root 'HOST06_V9_B1_PRODUCTION_CARRIER.ps1'
$launcherPath = Join-Path $root 'HOST06_V9_B1_LAUNCHER.ps1'
$stdinParentPath = Join-Path $root 'HOST06_V9_B1_STDIN_PARENT.ps1'
...
$newHelper = 'C:\Users\marti\AppData\Local\Temp\horizon-archive-host06-native-identity-v9-5825b06f-e16d-4518-b924-6d50809e3a33'
$oldLive = 'C:\Users\marti\AppData\Local\Temp\horizon-archive-host06-api-6eae8313-1407-492d-af7c-675051ab8e08'
$newLive = 'C:\Users\marti\AppData\Local\Temp\horizon-archive-host06-api-v9-ca96f453-a3ca-439b-b45a-635652d387ba'
...
namespace HorizonArchive.Host06V9 {
...
$transport = @'
  ...
  $production.Ordinal='B1'
  $production.Stage='PT09_SEND_ENTRY'
  $stagePath=$liveRoot+'\.attempt-B1-8958da5b-9968-47f5-bf36-0209793eaf6a.stage'
  $targetPath=$liveRoot+'\attempt-B1.png'
  $decisionPath=$liveRoot+'\.attempt-B1.review-v1'
  ...
  try{[HorizonArchive.Host06V9.StrictJson]::Validate($responseText);$responseObject=$serializer.DeserializeObject($responseText)}catch{throw 'PT10_RESPONSE_ENVELOPE'}
  if($status-ne 200){
    try{
...
$carrier = $carrier.Replace("'HOST06_REVIEW_READY|ordinal='+`$ordinal", "'HOST06_REVIEW_READY|ordinal=B1'")
$carrier = $carrier.Replace("'\AHOST06_REVIEW_V1\|ordinal='+`$ordinal+'\|decision=", "'\AHOST06_REVIEW_V1\|ordinal=B1\|decision=")
...
$carrier = $carrier.Replace('Work Order: FRWO-005-v7', 'Work Order: FRWO-005-v9').Replace('Shell: FRSH-005-v1 through FRSH-005-v1-VR-11', 'Shell: FRSH-005-v1-VR-40').Replace('Consumed ordinals: "+$(if($ordinal-eq 2){''2 accepted''}else{''2 objective rejection; 3 accepted''})+"', 'Consumed attempt: B1 accepted').Replace('Selected attempt: attempt-0"+$ordinal+".png', 'Selected attempt: attempt-B1.png')
...
$carrier = $carrier.Replace("'HOST06_PRODUCTION_COMPLETE|ordinal='+`$ordinal", "'HOST06_PRODUCTION_COMPLETE|attempt=B1'")

if($carrier.Contains('foreach ($ordinal in @(2,3))') -or $carrier.Contains('attempt-02') -or $carrier.Contains('attempt-03')){throw 'B1_PATCH'}
if(-not $carrier.Contains('HorizonArchive.Host06V9.StrictJson') -or -not $carrier.Contains('.attempt-B1-8958da5b-9968-47f5-bf36-0209793eaf6a.stage')){throw 'PARSER_PATCH'}
