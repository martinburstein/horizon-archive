...
$parentPath=Join-Path $root 'HOST06_V9_B1_STDIN_PARENT.ps1'
$controlled=@(
'C:\Users\marti\AppData\Local\Temp\horizon-archive-host06-native-identity-v9-5825b06f-e16d-4518-b924-6d50809e3a33',
'C:\Users\marti\AppData\Local\Temp\horizon-archive-host06-api-v9-ca96f453-a3ca-439b-b45a-635652d387ba',
...
try{
  ...
  [Console]::Out.WriteLine('HOST06_V9_STDIN_FIXTURE_PASS|earliestStage=PT06_CREDENTIAL_GATE|childInvocations=1|credentialReads=0|requestConstructions=0|sendAsyncCalls=0|apiSends=0|B1Consumed=false|controlledPathsAbsent=true')
