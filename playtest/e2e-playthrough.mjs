...
print("Operator:", learner)`);
  ...
  await page.getByText("SYSTEM // Existing evidence is finalized. SCENE // The branches, basin, Crown, and route remain unchanged. PILOT // I'll follow the material trail already ahead. SYSTEM // The current continuation is available.", { exact: true }).waitFor();
