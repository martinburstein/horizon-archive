...
source_url: https://learn.microsoft.com/en-us/training/modules/introduction-computer-vision/5-modern-vision-models/
...
![Diagram of token vectors in a 3D space.](assets/5-modern-vision-models/image_001.png)
...
![Diagram of a photo with patches assigned to vectors.](assets/5-modern-vision-models/image_002.png)
...
![Diagram of vision embeddings.](assets/5-modern-vision-models/image_003.png)
...
![Diagram of a multi-modal model that combines language and vision embeddings.](assets/5-modern-vision-models/image_004.png)
...
![Photograph of a person in a park with a hat and a backpack.](assets/5-modern-vision-models/image_005.png)
