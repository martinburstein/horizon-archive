...
source_url: https://learn.microsoft.com/en-us/training/modules/get-started-ai-fundamentals/3-computer-vision/
...
![Screenshot of a computing history site performing image analysis.](assets/3-computer-vision/image_001.png)

## How does computer vision work?

Computer vision is accomplished by using large numbers of images to train a model.

![Diagram of a computer vision model being trained with a large volume of images.](assets/3-computer-vision/image_002.png)
