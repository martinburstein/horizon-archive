...
source_url: https://learn.microsoft.com/en-us/training/modules/fundamentals-generative-ai/3-language-models/
...
![Diagram of the Transformer architecture with the encoding and decoding layers.](assets/3-language-models/image_001.png)
...
![Diagram of embedding vectors for tokens in three-dimensions.](assets/3-language-models/image_002.png)
