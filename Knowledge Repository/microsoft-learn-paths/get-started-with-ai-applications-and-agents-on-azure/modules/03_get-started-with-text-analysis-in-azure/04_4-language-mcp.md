...
source_url: https://learn.microsoft.com/en-us/training/modules/get-started-text-analysis-azure/4-language-mcp/
...
![Screenshot of the Foundry playground with a deployed model and a dialog box to save as an agent.](assets/4-language-mcp/image_001.png)
...
![Screenshot of the dialog box used to configure the connection between the agent and Azure Language in Foundry Tools.](assets/4-language-mcp/image_002.png)
...
![Screenshot of the Azure Language in Foundry Tools connected to an agent in the Foundry portal.](assets/4-language-mcp/image_003.png)
