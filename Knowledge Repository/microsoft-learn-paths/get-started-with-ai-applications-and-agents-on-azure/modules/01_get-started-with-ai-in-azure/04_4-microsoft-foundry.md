...
source_url: https://learn.microsoft.com/en-us/training/modules/get-started-with-ai-in-azure/4-microsoft-foundry/
...
![Screenshot of elements within Foundry including icons for models, tools, agents, tools, and knowledge.](assets/4-microsoft-foundry/image_001.png)
...
![Screenshot of Foundry main page.](assets/4-microsoft-foundry/image_002.png)
...
![Screenshot of Foundry Docs page with the agent helper open.](assets/4-microsoft-foundry/image_003.png)
...
2. In Foundry, pick a model from the Model Catalog and deploy it.
   ![Screenshot of a selected model.](assets/4-microsoft-foundry/image_004.png)
3. In Foundry, experiment with the model in the Playground. You can use the Playground to write prompts, test model responses, configure parameters.
   ![Screenshot of the model in the Foundry playground.](assets/4-microsoft-foundry/image_005.png)
