...
source_url: https://learn.microsoft.com/en-us/training/modules/get-started-vision-azure/2-vision-enabled-models/
...
[![Screenshot of Foundry Playground with a gpt-4.1 mini model deployed and the user uploading an image of an animal.](assets/2-vision-enabled-models/image_001.png)](https://learn.microsoft.com/en-us/training/modules/wwl-data-ai/get-started-vision-azure/media/playground-upload-image.png#lightbox)

For example, you can attach an image file and get the multimodal model (such as gpt-4.1 mini) to analyze and describe it.

[![Screenshot of Foundry Playground with a prompt asking the model to describe what is in an image and a response with a description.](assets/2-vision-enabled-models/image_002.png)](https://learn.microsoft.com/en-us/training/modules/wwl-data-ai/get-started-vision-azure/media/image-analysis-result-playground.png#lightbox)
...
![Screenshot of the image used for image analysis.](assets/2-vision-enabled-models/image_003.png)

Then you can write application code that uses the OpenAI API to connect to your model's endpoint in Foundry.

[![Screenshot of Visual Studio Code with a python file containing application code for image analysis.](assets/2-vision-enabled-models/image_004.png)](https://learn.microsoft.com/en-us/training/modules/wwl-data-ai/get-started-vision-azure/media/vision-analysis-python.png#lightbox)
...
[![Screenshot of Visual Studio Code with the result of the image analysis.](assets/2-vision-enabled-models/image_005.png)](https://learn.microsoft.com/en-us/training/modules/wwl-data-ai/get-started-vision-azure/media/image-analysis-result-vs-code.png#lightbox)
