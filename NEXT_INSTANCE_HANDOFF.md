...
- Route: sole Pilot-owned `TD008-RTA-001` from exact TD-007 BV-30.
- Graph: `BV-30 -> OR-00 -> OR-10 -> OR-20 -> OR-30`.
...
- Exactly one provisional surface-safe candidate is derived: a bounded
  exposed-edge reconciliation study with three separately traceable near
...
- The retained RP-007 summary and complete TD-008 record remain exact and may
  ...
  learning credit.
- The Colonel candidate's six observations remain equal and any-order.
