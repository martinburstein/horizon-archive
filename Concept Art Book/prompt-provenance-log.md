# Horizon Archive Prompt and Provenance Log

Active visual authority: [Photorealistic Visual Direction](../Visual%20Direction/PHOTOREALISTIC_CHARTER.md).
...
- **Preserved:** first-person world plates, no protagonist/ship/human trace, Builder functionality, collective stewardship, Glass Garden flatness and cultivation logic, Terminal interconnection, screen-only animation registration, clean plates, originality, and spoiler protocol.
...
## 2026-07-26 — RP-003 expedition provenance carrier reveal

- **Decision:** close `RP-003 / RP003-IE-01 — expedition provenance carrier preserves an honest unavailable-input boundary`.
