...
| SC-03 | Civic Record District | World D / Volcanic Habitation Vault / City Beneath civic district | Brief — A2 second-near-dispatch presentation locked; no final art | Premium near/far evidence; one recorded plus two available near actions, exact second acknowledgement, retained first fact, separate returns, Tour, save, and invariant world remain owner-distinct | [Sheet](scenes/SC-03-civic-record-district.md) · [Historical scale reference](../Concept%20Art/Underground%20City.png) |
...
Next coverage recommendation: Curriculum Checker should perform only the RP-002 A3 one-ID-to-second-near-dispatch presentation-preservation review. Preserve both SOLIDIFIED chains, all six ordered first/second prefixes, byte-stable first-ID retention, recorded-action replay, either available second action, exact Scene/System `2 of 3` acknowledgement, separate returns, fail-closed recovery, atomic save, Tour isolation, and zero-credit presentation. SC-02 and SC-03 remain briefs with no final art.
