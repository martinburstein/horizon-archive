...
| SC-03 | Civic Record District | World D / Volcanic Habitation Vault / City Beneath civic district | Brief — A2 executable-literacy impact review locked; no final art | Premium near/far material evidence plus an occupational stewardship coupling; incomplete Python and its related record remain in separate suit UI beside a closed identity interlock | [Sheet](scenes/SC-03-civic-record-district.md) · [Historical scale reference](../Concept%20Art/Underground%20City.png) |
...
Next coverage recommendation: Curriculum Checker should perform RP-002 A3 mapping-preservation review against the executable-literacy-revalidated SC-03 boards. SC-02 and SC-03 remain briefs with no final art; existing replacement priorities remain unchanged.
