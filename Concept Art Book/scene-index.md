...
| SC-03 | Civic Record District | World D / Volcanic Habitation Vault / City Beneath civic district | Brief — A2 photorealistic impact review locked; no final art | Premium near/far material evidence for fixed trace, later stewardship, and solid outlined gap beside a separately closed identity-bearing interlock | [Sheet](scenes/SC-03-civic-record-district.md) · [Historical scale reference](../Concept%20Art/Underground%20City.png) |
...
Next coverage recommendation: Curriculum Checker should perform RP-002 A3 against the photorealistically revalidated SC-03 boards. SC-02 and SC-03 remain briefs with no final art; existing replacement priorities remain unchanged.
