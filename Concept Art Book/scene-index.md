...
| SC-03 | Civic Record District | World D / Volcanic Habitation Vault / City Beneath civic district | Brief — A2 first-near-dispatch presentation locked; no final art | Premium near/far evidence; blank observation, three equal near actions, one exact Scene acknowledgement, separate returns, Tour, save, and invariant world remain owner-distinct | [Sheet](scenes/SC-03-civic-record-district.md) · [Historical scale reference](../Concept%20Art/Underground%20City.png) |
...
Next coverage recommendation: Curriculum Checker should perform only the RP-002 A3 blank-to-first-near-dispatch presentation-preservation review. Preserve both SOLIDIFIED chains, three equal near actions and all six orders, one-action/one-ID dispatch, exact Scene/System acknowledgement, separate returns, fail-closed recovery, atomic save, Tour isolation, and zero-credit presentation. SC-02 and SC-03 remain briefs with no final art.
