...
| SC-03 | Civic Record District | World D / Volcanic Habitation Vault / City Beneath civic district | Brief — A2 transfer-origin impact review locked; no final art | Premium near/far material evidence plus an occupational stewardship coupling; the sole Builder work, suit result, fresh expedition practice, and human-owned explanation remain distinctly sequenced in separate suit UI beside a closed identity interlock | [Sheet](scenes/SC-03-civic-record-district.md) · [Historical scale reference](../Concept%20Art/Underground%20City.png) |
...
Next coverage recommendation: Curriculum Checker should perform RP-002 A3 mapping-preservation review against the transfer-origin-revalidated SC-03 interface sequence. SC-02 and SC-03 remain briefs with no final art; existing replacement priorities remain unchanged.
