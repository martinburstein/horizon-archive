...
- **Production status:** Brief — A2 photorealistic, responsive-composition, executable-literacy, transfer-origin, responsible-AI primary/remediation, and responsible-AI transfer/explanation presentation reviews locked; no final art
...
| `SC-03-30` | Changed expedition state | Reuse overview and continuous clock; separate responsive suit UI sequences the sole unfinished Builder work image, causal suit result, fresh expedition practice, Teacher prompt, Pilot-owned conclusion, then course-authored RAI primary/remediation, blank System-owned transfer, Teacher-owned assessment/explanation, and the bounded Pilot conclusion | Save bounded comparison -> `40`; cancel to overview |
...
- **Locked:** direct SC-02 adjacency; board order; three base compositions; semantic target ownership and attention order; near/far three-condition relation; occupational local coupling; separate closed interlock; suit-only five-group Python origin sequence from sole Builder work through Pilot-owned conclusion; post-`30-E` course-authored RAI primary -> Teacher field-associated miss -> System guided practice -> blank retry -> fresh System-owned transfer -> Teacher transfer feedback/blank retry -> Teacher three-boundary explanation -> Teacher explanation feedback/blank retry -> Pilot conclusion sequence; one active owner/message/case/action group at a time; visible provisional suit, expedition System, Teacher, and Pilot ownership with no Builder speaker; no carried primary result into transfer; no world delta; no successor route; responsive world/interface separation.
