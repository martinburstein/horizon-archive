...
const shellLongestCopy = Object.freeze(__TD010_SHELL_LONGEST_COPY__);
...
function FrozenCopy({ enabled, layout }) { return enabled ? <section className="fixture-frozen-copy" data-layout={layout}><h2>Frozen longest-copy containment evidence</h2>{Object.entries(shellLongestCopy).map(([key, value]) => <p key={key} data-frozen-copy={key}>{value}</p>)}</section> : null; }
