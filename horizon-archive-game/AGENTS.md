...
- Glass Garden canon is fictional Builder technology, not real-world science: silicate feedstock is cultivated through slurry/water beds into glass that grows upward like inverted icicles, is trained into multiple component typologies, stress/temperature controlled, marked for maturity, harvested, annealed, transported, rejected, repaired, and used by the Python-running Terminals. Make the process visible; reject random fantasy crystals.
