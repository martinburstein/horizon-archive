...
- Glass Garden canon is fictional Builder technology, not real-world science: silicate feedstock is cultivated through flush/subsurface slurry-water ground cells into glass that grows upward like inverted icicles, is trained into multiple component typologies, stress/temperature controlled, marked for maturity, harvested, annealed, transported, rejected, repaired, and used by the Python-running Terminals. Make the process visible; reject random fantasy crystals.
- Glass Garden terrain is absolutely flat at gigantic agricultural scale, with a ruler-straight horizon and glass crop continuing to every edge. Cultivated glass is the only vertical landform. Reject mountains, hills, terraces, ridges, shelves, monuments, skyline architecture, valleys, bowls, basins, overlooks, and human crop rows/roads/fences. Depth comes only from atmosphere, occlusion, maturity/component-shape variation, cluster compression, and waves of process-state.
- All environments express alien functionality: a landscape-scale working system and inferred occupation integrating resource extraction or terraforming, machine, and ecology. Builder artifacts are more advanced than human civilization as of 2026, were never designed for human eyes or ergonomics, and are first encountered by a human here. Teach interaction through repetition, state, routed matter/energy, and consequence—not labels or familiar controls. Require multiple plausible operating layers and system evidence for every strange form; reject both human-default design and random surrealism.
