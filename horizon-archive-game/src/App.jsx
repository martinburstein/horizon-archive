...
export function App() {
  ...
  const activeSceneHotspots = scene.id === "ruins" && strandedLensCradleActive
    ...
    : sceneHotspots;
  const presentedSceneHotspots = scene.id === "ruins" && tidalPatternLoomActive
